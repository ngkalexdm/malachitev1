...
@Entity(name="Tab_arriere_avance")
public class arriere_avance {
	@Id
	...
	public arriere_avance(Integer id, Long id_adherent, Integer id_exercice, Double mois_1, Double mois_2, Double mois_3,
