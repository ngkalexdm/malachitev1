...
/* [dbo].[Tab_pyramide_age_beneficiaire](
	[id] [bigint] NOT NULL,
	...
	[a_90] [int] NULL,
	[a_100] [int] NULL,*/
@Entity(name="Tab_pyramide_age_beneficiaire")
public class pyramide_age_beneficiaire {
	...
	pyramide_age_beneficiaire(Long id, Integer id_exercice, String sexe, Integer a_10, Integer a_20, Integer a_30,
